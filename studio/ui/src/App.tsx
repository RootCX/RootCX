...
export default function App() {
  ...
  const isOnline = status?.runtime.state === "online";
  ...
  return (
    <div className="container">
      ...
      {loading && <p className="loading">Connecting to Runtime...</p>}
      ...
      {status && (
        <div className="status-grid">
          <div className="card">
            <h2>Runtime</h2>
            <Badge label="Status" state={status.runtime.state} />
            <div className="detail">
              <span>Version</span>
              <code>{status.runtime.version}</code>
            </div>
          </div>
