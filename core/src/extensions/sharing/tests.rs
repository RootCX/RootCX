...
mod guard_tests {
    ...
    fn anonymous_rpc_without_scope_allows_anonymous() {
        let decl = PublicRpc { publications: vec![], name: "list_products".into(), scope: vec![] };
    ...
    fn scoped_rpc_requires_share_token_rejects_anonymous() {
        let decl = PublicRpc { publications: vec![], name: "get_public_board".into(), scope: vec!["board_id".into()] };
    ...
    fn scoped_rpc_with_multiple_scope_keys_all_must_match() {
        let decl = PublicRpc { publications: vec![], name: "get_detail".into(), scope: vec!["org_id".into(), "doc_id".into()] };
    ...
    fn scoped_rpc_rejects_when_context_missing_required_key() {
        ...
        let decl = PublicRpc { publications: vec![], name: "view".into(), scope: vec!["project_id".into()] };
    ...
    fn scoped_rpc_rejects_type_mismatch_same_string_value() {
        ...
        let decl = PublicRpc { publications: vec![], name: "view".into(), scope: vec!["id".into()] };
    ...
    fn scoped_rpc_rejects_extra_nested_object_injection() {
        ...
        let decl = PublicRpc { publications: vec![], name: "view".into(), scope: vec!["board_id".into()] };
