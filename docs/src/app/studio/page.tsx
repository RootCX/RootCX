        ...
        <DocsLayout toc={toc}>
            <div className="flex flex-col gap-10">
                ...
                <section className="flex flex-col gap-4" id="getting-started">
                    ...
                    <ol className="flex flex-col gap-3 text-muted-foreground text-sm leading-7 list-none">
                        {[
                            ...
                            ["Status bar updates", "Once healthy, the status bar shows green indicators for PostgreSQL and Runtime."],
                            ["Ready", "You can now install apps, write code, and deploy workers."],
                        ].map(([title, desc], i) => (
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {[
                                    ...
                                    ["Forge", "Right sidebar", "Deploy workers and manage worker lifecycle"],
                                    ["Console", "Bottom drawer", "Live log stream from running workers"],
                                    ["Command Palette", "Floating overlay (⌘K)", "Keyboard-driven access to all commands"],
                                    ["Status Bar", "Bottom strip", "PostgreSQL, Runtime, and Forge health indicators"],
                ...
                <section className="flex flex-col gap-4" id="file-explorer">
                    ...
                    <p className="text-muted-foreground leading-7">
                        The File Explorer occupies the left sidebar and displays the contents of your current <strong className="text-foreground font-medium">workspace directory</strong>. A workspace is simply a folder on your local filesystem containing your worker code, manifest, and any other project files.
                    </p>
                    <p className="text-muted-foreground leading-7">
...
└── .env              ← Local env (not deployed)`} />
                ...
                <section className="flex flex-col gap-4" id="forge">
                    ...
                    <p className="text-muted-foreground leading-7">
                        The <strong className="text-foreground font-medium">Forge panel</strong> is Studio's deployment center, located in the right sidebar. It shows the current worker status for the active app and provides controls to deploy, start, and stop the worker process.
                    </p>
                    <p className="text-muted-foreground leading-7">
                        When you click <strong className="text-foreground font-medium">Deploy</strong>, Studio packages your workspace as a <code className="rounded bg-white/5 px-1.5 py-0.5 font-mono text-xs text-foreground">.tar.gz</code> archive, uploads it to the Core API, and Core extracts, installs dependencies, and spawns the worker. The deployment log in the Forge panel shows each step as it happens.
                    </p>
                    <p className="text-muted-foreground leading-7">
                        See the <Link href="/studio/forge" className="text-primary hover:underline">Forge reference</Link> for the full deployment flow and worker requirements.
                    </p>
                </section>
                ...
                <section className="flex flex-col gap-4" id="console">
                    ...
                    <div className="flex flex-col gap-2">
                        {[
                            ["info", "text-blue-400", "bg-blue-500/10 border-blue-500/20", "Standard informational output from your worker"],
                            ["warn", "text-yellow-400", "bg-yellow-500/10 border-yellow-500/20", "Non-fatal warnings — worker continues running"],
                    ...
                    <p className="text-muted-foreground leading-7">
                        Each log line includes a <strong className="text-foreground font-medium">timestamp</strong> in ISO 8601 format. The console auto-scrolls to the latest line. Use the <strong className="text-foreground font-medium">Clear</strong> button to wipe the current console buffer without affecting the worker. Toggle the console with <code className="rounded bg-white/5 px-1.5 py-0.5 font-mono text-xs text-foreground">⌘`</code>.
                    </p>
                </section>
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {[
                                    ...
                                    ["Deploy Worker", "Trigger a fresh package and deployment of the current workspace"],
                                    ["Start Worker", "Start the worker without re-deploying"],
                                    ["Stop Worker", "Gracefully stop the running worker"],
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {[
                                    ...
                                    ["⌘⇧P", "Ctrl+Shift+P", "Deploy worker (Forge)"],
                ...
                <section className="flex flex-col gap-4" id="core-status">
                    ...
                    <div className="flex flex-col gap-2">
                        {[
                            ...
                            ["Runtime", "green", "Core HTTP API is up and responding to requests on port 9100"],
                            ["Forge", "grey", "Worker status: green = running, grey = stopped, red = crashed"],
                ...
                <section className="flex flex-col gap-4" id="whats-next">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            ...
                            { href: "/studio/forge", title: "Deployment — Forge", desc: "Full deployment flow, worker requirements, and package structure." },
